          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            <Card>
              ...
              <CardContent className="space-y-4">
                <Input
                  label="Nama Produk"
                  placeholder="Contoh: Kit Hidroponik NFT 6 Lubang"
                  value={form.name}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Deskripsi pendek untuk kartu produk..."
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <label className="flex cursor-pointer items-center justify-between rounded-lg border p-3">
                  ...
                  >
                    <div
                      className={`absolute top-0.5 h-5 w-5 rounded-full bg-white shadow transition-transform ${form.featured ? "translate-x-[22px]" : "translate-x-0.5"}`}
                    />
                  </div>
                </label>
                  ...
                  {form.tags.length > 0 && (
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      {form.tags.map((tag) => (
                        <span
                          key={tag}
                          className="inline-flex items-center gap-1 rounded-full bg-[#1B4D3E]/10 px-2.5 py-0.5 text-xs font-medium text-[#1B4D3E]"
                        >
                          {tag}
